...
public class WordWorker {
    ...
    public WordWorker(String fileSaveToPath){
        this.fileSavePath = fileSaveToPath;
    }

    public void createWordReport(String nameFle) {
        try {
            ...
            FileOutputStream outputStream = new FileOutputStream(fileSavePath + nameFle);
