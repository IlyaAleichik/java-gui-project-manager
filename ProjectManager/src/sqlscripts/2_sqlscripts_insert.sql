...
INSERT INTO projects(PROJECT_DATE_CREATION,PROJECT_TIME_CREATION,PROJECT_TERM_DELIVERY,PROJECT_COST_DELIVERY,PROJECT_NAME,PROJECT_DESCRIPTION,PROJECT_CURRENCY_ID,PROJECT_USER_ID) VALUES (CURRENT_DATE, CURRENT_TIME, '2020-12-22',25.0,'APM Series','Система управлеия производительностью приложений','1','2');
...
INSERT INTO tasks(TASK_NAME,TASK_NOTE,TASK_STATE_ID,TASK_PRIORITY_ID,TASK_PROJECT_ID) VALUES 
('Авторизация','Сделать функцию лучени формы','5','2','1');
INSERT INTO tasks(TASK_NAME,TASK_NOTE,TASK_STATE_ID,TASK_PRIORITY_ID,TASK_PROJECT_ID) VALUES 
('Работа с даграммами','Сделать диаграммы','3','1','1');
...
INSERT INTO risks(RISK_LOSS_INCOME,RISK_LOSS_TIME_INDAY,RISK_NAME,RISK_AVAILABILITY_ID,RISK_PROJECT_ID) VALUES
('100000','60','Интеграция с существующими информационными системами Заказчика','1','1');
INSERT INTO risks(RISK_LOSS_INCOME,RISK_LOSS_TIME_INDAY,RISK_NAME,RISK_AVAILABILITY_ID,RISK_PROJECT_ID) VALUES
('60000','0','Недостаточный уровень знаний пользователей','1','1');
